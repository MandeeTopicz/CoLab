    ...
    <section id="about" className="scroll-mt-24 py-14 sm:py-20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-7 sm:mt-8">
          <div className="relative border border-border/70 bg-[#67AAF9]/90 p-6 shadow-[0_14px_28px_rgba(0,0,0,0.28)] sm:ml-6 sm:mr-24 sm:-rotate-1">
            <div
              aria-hidden="true"
        ...
        <div className="mt-12 grid grid-cols-1 gap-14 sm:mt-16 sm:grid-cols-2 sm:gap-20">
          <div className="relative border border-border/70 bg-[#2EC0F9]/90 p-5 shadow-[0_14px_28px_rgba(0,0,0,0.28)] sm:-rotate-1 sm:-translate-y-1">
            <div
              aria-hidden="true"
          ...
          <div className="relative border border-border/70 bg-[#9BBDF9]/90 p-5 shadow-[0_14px_28px_rgba(0,0,0,0.28)] sm:rotate-1 sm:translate-y-2">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute left-1/2 top-2 h-4 w-16 -translate-x-1/2 rounded-md bg-white/35 shadow-xs backdrop-blur-[1px]"
            />
        ...
        <div className="mt-20 sm:mt-24">
          ...
          <div className="mt-10 grid grid-cols-1 gap-14 sm:grid-cols-3 sm:gap-20">
            <div className="relative border border-border/70 bg-[#C4E0F9]/90 p-5 text-center shadow-[0_14px_28px_rgba(0,0,0,0.28)] sm:-rotate-1 sm:-translate-y-1">
              <div
                aria-hidden="true"
            ...
            <div className="relative border border-border/70 bg-[#B388EB]/90 p-5 text-center shadow-[0_14px_28px_rgba(0,0,0,0.28)] sm:rotate-1 sm:translate-y-3">
              <div
                aria-hidden="true"
                className="pointer-events-none absolute left-1/2 top-2 h-4 w-14 -translate-x-1/2 rounded-md bg-white/35 shadow-xs backdrop-blur-[1px]"
              />
            ...
            <div className="relative border border-border/70 bg-[#F7AEF8]/90 p-5 text-center shadow-[0_14px_28px_rgba(0,0,0,0.28)] sm:-rotate-[0.5deg] sm:translate-y-1">
              <div
                aria-hidden="true"
                className="pointer-events-none absolute left-1/2 top-2 h-4 w-14 -translate-x-1/2 rounded-md bg-white/35 shadow-xs backdrop-blur-[1px]"
              />
        ...
        <div className="mt-20 sm:mt-24">
          <div className="relative mx-auto border border-border/70 bg-[#67AAF9]/90 p-6 shadow-[0_14px_28px_rgba(0,0,0,0.28)] sm:max-w-xl sm:rotate-1">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute left-1/2 top-2 h-4 w-16 -translate-x-1/2 rounded-md bg-white/35 shadow-xs backdrop-blur-[1px]"
            />
